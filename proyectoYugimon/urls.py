...
urlpatterns = [
    ...
    path('addCartaBanlist/', addCartaBanlist, name='ingresoCartaBanlist'),
    path('editarCartaBanlist/', editarCartaBanlist, name="editarCartaBanlist"),
    path('eliminarCartaBanlist', eliminarCartaBanlist, name="eliminarCartaBanlist"),
]
# >>>>>>> feature/banlist
